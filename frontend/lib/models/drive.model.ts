...
const driveSchema = new mongoose.Schema({
  ...
  eligibilityCriteria: { type: String, required: function() { return this.driveStatus !== 'draft'; } },
...
export const Drive = mongoose.models.Drive || mongoose.model("Drive", driveSchema);